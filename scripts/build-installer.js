...
// Builds the Windows release payload and emits the guided Inno Setup installer.
...
if (!iscc) {
  fail("Unable to find Inno Setup compiler. Install Inno Setup 6 or set ISCC_EXE to the full path of ISCC.exe before running npm run installer:win.");
}
